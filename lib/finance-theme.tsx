...
const light = {
  background: "#F6F8F7", surface: "#FFFFFF", elevated: "#EDF3F0", text: "#16332F", muted: "#4B625D", border: "#D4DFDB",
  primary: "#0B6B62", onPrimary: "#FFFFFF", primaryDark: "#064E47", positive: "#159A6B", warning: "#D98B18", negative: "#D94343", accent: "#E6F2EE",
};
const dark = {
  background: "#102522", surface: "#18312D", elevated: "#21433D", text: "#E8F2EF", muted: "#A8BAB4", border: "#2A4B44",
  primary: "#66C7B5", onPrimary: "#082F2A", primaryDark: "#0B6B62", positive: "#54C796", warning: "#F0B64B", negative: "#F07878", accent: "#204C43",
};
