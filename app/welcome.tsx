  ...
  return <ScreenContainer edges={["top", "bottom", "left", "right"]} containerClassName="bg-background">
    <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
      ...
      {step === "welcome" ? <>
        ...
        <Pressable onPress={startFresh} style={({ pressed }) => [styles.primary, { backgroundColor: colors.primary, opacity: pressed ? 0.84 : 1 }]}><Text style={[styles.primaryText, { color: colors.onPrimary }]}>Começar a organizar</Text><MaterialIcons name="arrow-forward" size={20} color={colors.onPrimary} /></Pressable>
        ...
        <Pressable onPress={finishFresh} style={({ pressed }) => [styles.primary, { backgroundColor: colors.primary, opacity: pressed ? 0.84 : 1 }]}><Text style={[styles.primaryText, { color: colors.onPrimary }]}>Concluir e abrir painel</Text><MaterialIcons name="check" size={20} color={colors.onPrimary} /></Pressable>
