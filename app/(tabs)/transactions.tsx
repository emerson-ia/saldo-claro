...
import { currentMonth, formatMoney, isInMonth, shiftMonth, type Transaction } from "@/lib/finance-domain";
...
export default function TransactionsScreen() {
  ...
  const filtered = useMemo(() => transactions.filter((item) => {
    const matchesMonth = isInMonth(item.date, month);
  ...
  }).sort((a, b) => b.date.localeCompare(a.date)), [transactions, query, filter, month]);
